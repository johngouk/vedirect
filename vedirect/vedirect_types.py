...
fieldTypes = {
    ...
    'current': (fieldday.FieldInt, {'desc': 'Main or channel 1 battery current', 'units': 'mA', 'fmt': 'd'}),
    ...
    'load': (fieldday.FieldStr, {'desc': 'Load output state (ON/OFF)', 'units': '', 'fmt': 's'}),
    ...
    'alarmState': (fieldday.FieldStr, {'desc': 'Alarm condition active', 'units': '', 'fmt': 'd'}),
    'relayState': (fieldday.FieldStr, {'desc': 'Relay state', 'units': '', 'fmt': 'd'}),
    'alarmReason': (fieldday.FieldInt, {'desc': 'Alarm reason', 'units': '', 'fmt': 'd'}),
    'offReason': (fieldday.FieldInt, {'desc': 'Off reason', 'units': '', 'fmt': 'd'}),
    ...
    'numberOfChargeCycles': (fieldday.FieldInt, {'desc': 'Number of charge cycles', 'units': '', 'fmt': 'd'}),
    'numberOfFullCDischarges': (fieldday.FieldInt, {'desc': 'Number of full discharges', 'units': '', 'fmt': 'd'}),
    ...
    'timeSinceLastFullCharge': (fieldday.FieldInt, {'desc': 'Number of seconds since last full charge', 'units': 's', 'fmt': 'd'}),
    'numberOfAutoSynchs': (fieldday.FieldInt, {'desc': 'Number of automatic synchronizations', 'units': '', 'fmt': 'd'}),
    'numberOfLowMainVoltageAlarms': (fieldday.FieldInt, {'desc': 'Number of low main voltage alarms', 'units': '', 'fmt': 'd'}),
    'numberOfHighMainVoltageAlarms': (fieldday.FieldInt, {'desc': 'Number of high main voltage alarms', 'units': '', 'fmt': 'd'}),
    'numberOfLowAuxVoltageAlarms': (fieldday.FieldInt, {'desc': 'Number of low auxiliary voltage alarms', 'units': '', 'fmt': 'd'}),
    'numberOfHighAuxVoltageAlarms': (fieldday.FieldInt, {'desc': 'Number of high auxiliary voltage alarms', 'units': '', 'fmt': 'd'}),
    ...
    'yieldTotal': (fieldday.FieldInt, {'desc': 'Yield total (user resettable counter)', 'units': '0.01 kWh', 'fmt': 'd'}),
    ...
    'error': (fieldday.FieldInt, {'desc': 'Error code', 'units': 'Error code', 'fmt': 'd'}),
    'mode': (fieldday.FieldInt, {'desc': 'State of operation', 'units': '', 'fmt': 'd'}),
    'modelDescription': (fieldday.FieldStr, {'desc': 'Model description (deprecated)', 'units': '', 'fmt': 's'}),
    'firmwareVersion': (fieldday.FieldStr, {'desc': 'Firmware version (16 bit)', 'units': '', 'fmt': 's'}),
    'firmwareVersion24Bit': (fieldday.FieldStr, {'desc': 'Firmware version (24 bit)', 'units': '', 'fmt': 's'}),
    'productId': (fieldday.FieldStr, {'desc': 'Product ID', 'units': '', 'fmt': 's'}),
    'serialNumber': (fieldday.FieldStr, {'desc': 'Serial number', 'units': '', 'fmt': 's'}),
    'daySequenceNumber': (fieldday.FieldInt, {'desc': 'Day sequence number (0..364)', 'units': '', 'fmt': 'd'}),
    'deviceMode': (fieldday.FieldInt, {'desc': 'Device mode', 'units': '', 'fmt': 'd'}),
    ...
    'warningReason': (fieldday.FieldInt, {'desc': 'Warning reason', 'units': '', 'fmt': 'd'}),
    'trackerMode': (fieldday.FieldInt, {'desc': 'Tracker operation mode', 'units': '', 'fmt': 'd'})
}
